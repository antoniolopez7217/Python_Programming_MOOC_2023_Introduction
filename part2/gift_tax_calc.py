...
if gift < 5000:
    ...
    print("Amount of tax: ", end="")
    if 5000 <= gift < 25000:
        total = 100 + (gift - 5000) * 0.08
    elif 25000 <= gift < 55000:
        total = 1700 + (gift - 25000) * 0.1
    elif 55000 <= gift < 200000:
        total = 4700 + (gift - 55000) * 0.12
    elif 200000 <= gift < 1000000:
        total = 22100 + (gift - 200000) * 0.15
    elif 1000000 <= gift:
        total = 142100 + (gift - 1000000) * 0.17
    print(f"{total} euros")
